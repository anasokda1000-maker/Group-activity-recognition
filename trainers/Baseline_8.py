...
from utils import *
from models.Baseline_8 import Baseline_8
...
if __name__ == '__main__':
    ...
    optimizer = optim.AdamW(
        model.parameters(),
        lr = Configs['Baseline_8']['model']['lr'],
        weight_decay = Configs['Baseline_8']['model']['weight_decay']
    )	
    ...
    graph_train_losses = []
    graph_val_losses = []
    for epoch in range(Configs['Baseline_8']['num_epochs']):
